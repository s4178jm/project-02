...
class Main extends React.Component {
    ...
    makeSourceCall = async () => {
      let queryLink = 'https://newsapi.org/v2/sources?apiKey=996ed447772844b4861e0cf01a701324'
    ...
    makeUSCall = async (userInput) => {
      try {
        ...
        let queryLink = 'https://newsapi.org/v2/everything?q=' +
          ...
          '&domains=' +
          usSources +
          '&sortBy=popularity&pageSize=10&apiKey=996ed447772844b4861e0cf01a701324'
        const response = await axios.get(queryLink)
