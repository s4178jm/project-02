  ...
  if (props.city.name) {
    return (
      <div>
        ...
        <h3>Temp: {props.city.main.temp} &deg;F</h3>
        <h3>RealFeel: {props.city.main.feels_like} &deg;F</h3>
        ...
        <img src={`http://openweathermap.org/img/wn/${props.city.weather[0].icon}@2x.png`} /> 
      </div>
    );
  } else {
    return (
